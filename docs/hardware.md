...
|                                         Device                                         | Quantity | Connection |                           Home Assistant                            |                     Notes                      |
| :------------------------------------------------------------------------------------: | :------: | :--------: | :-----------------------------------------------------------------: | :--------------------------------------------: |
| [Zemismart Matter over Thread Curtain Motor](https://www.zemismart.com/products/mt25b) |    2     |   Thread   | [Matter (BETA)](https://www.home-assistant.io/integrations/matter/) | Using this for Main curtain and sheer curtain. |
