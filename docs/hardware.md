...
|  Device | Quantity | Connection | HomeAssistant | Notes |
| :---: | :---: | :---: | :---: | :---: |
| [AppleTV 4K 3rd](https://www.apple.com/lae/apple-tv-4k/) | 1 | LAN | [Thread](https://www.home-assistant.io/integrations/thread/) | Apple TV 4K 3세대를 메인 Thread Border Router로 사용합니다. SONOFF ZBDongle-E 동글에 연결된 OTBR 애드온을 백업 Thread Border Router로 사용합니다. |
...
|  Device | Quantity | Connection | HomeAssistant | Notes |
| :---: | :---: | :---: | :---: | :---: |
| [Aqara LED Bulb T2 E26](https://us.aqara.com/products/aqara-led-bulb-t2-e26) | 3 | Thread | [Matter (BETA)](https://www.home-assistant.io/integrations/matter/) | Matter over Thread를 지원하고 광질이 좋습니다. |
| [Aqara LED Bulb T2 GU10](ihttps://us.aqara.com/products/aqara-led-bulb-t2-gu10) | 1 | Thread | [Matter (BETA)](https://www.home-assistant.io/integrations/matter/) | 위와 동일 |
...
|  Device | Quantity | Connection | HomeAssistant | Notes |
| :---: | :---: | :---: | :---: | :---: |
| [SPEEL 터치넷 T2R 일괄소등+가스차단 스위치](http://speel.co.kr/project/%ec%9d%bc%ea%b4%84%ec%86%8c%eb%93%b1%ea%b0%80%ec%8a%a4%ec%b0%a8%eb%8b%a8-2/) | 1 | - | [ESPHome](https://www.home-assistant.io/integrations/esphome/) | 일괄소등 + 가스차단 기능. 하지만 가스는 하이라이트고 일괄소등은 전기를 끊는지라 사용하지 않습니다. |
...
| [Edifier MR5](https://www.edifier.com/int/global/p/studio-monitors/mr5) | 1 | - | [ESPHome](https://www.home-assistant.io/integrations/esphome/) | 위 Voice PE에 연결됩니다. |
...
| ![UniFi AP lite](images/unifi_ap_lite.png)[UniFi AC lite](https://techspecs.ui.com/unifi/wifi/uap-ac-lite) | 1 | LAN | [Unifi Network](https://www.home-assistant.io/integrations/unifi/) | 역시 혼자 사는 방에 충분합니다.|
...
| [xBloom Studio](https://xbloom.com/pages/xbloom-studio) | 1 | Bluetooth | - | 굉장히 편리합니다. |
